...
public class WMG_Axis : WMG_GUI_Functions {
	...
	[SerializeField] public List<string> _axisLabels;
	...
	public float numDecimalsAxisLabels { get {return _numDecimalsAxisLabels;} 
		set {
	...
	[SerializeField] private float _numDecimalsAxisLabels;
	...
	public void ChangeOrientation() {
		...
		float tnumDecimalsAxisLabels = numDecimalsAxisLabels;
	...
	public void ChangeOrientationEnd(labelTypes tLabelType, float tAxisMaxValue, float tAxisMinValue, int tAxisNumTicks, float tnumDecimalsAxisLabels,
